Select a spaceship from the map on the left (only those marked with the "▣" symbol can be selected) and click the "**Evolve from spaceship**" button to generate new spaceships.
